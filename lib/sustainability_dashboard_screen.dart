                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildListDelegate([
                        _buildGlobalHealthScoreCard(provider),
                        const SizedBox(height: 32),
                        _buildIntelligenceGrid(provider),
                        const SizedBox(height: 32),
