...
// Replace 'MainStorefrontScreen' with your desired destination
// or implement a simple placeholder for testing.
class MainStorefrontScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Center(child: Text("Welcome, $username", style: const TextStyle(color: Colors.white))),
  );
}
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text("Sign In", style: TextStyle(fontFamily: 'Serif', fontSize: 32, fontWeight: FontWeight.w300, color: Colors.white, letterSpacing: 1)),
                const SizedBox(height: 8),
                const Text("Access your personalized premium vanity profile dashboard.", style: TextStyle(fontSize: 13, color: Colors.white38)),
                ...
                ElevatedButton(
                  ...
                  child: const Text("AUTHENTICATE PROFILE", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 3)),
                ),
                ...
                Center(
                  child: TextButton(
                    ...
                    child: const Text("Create New Maison Membership Account", style: TextStyle(color: Color(0xFFD4AF37), fontSize: 12, letterSpacing: 0.5, decoration: TextDecoration.underline, decorationColor: Color(0xFFD4AF37))),
                  ),
                ),
              ],
            ),
