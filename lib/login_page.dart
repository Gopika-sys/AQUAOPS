...
import 'dashboard_screen.dart'; // Ensure this points to your new dashboard file
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _processLoginAuthentication() async {
    ...
    if (_usernameController.text.trim() == storedUser && _passwordController.text == storedPass) {
      if (!mounted) return;
      // Successfully navigated to DashboardScreen
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Authentication Denied."),
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: RadialGradient(
              ...
              radius: 1.2,
              colors: [Color(0xFF083344), Color(0xFF020617)]),
        ),
        child: Center(
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 60),
                  _buildAquaField(
                      _usernameController, "Username", Icons.water_drop_outlined, false),
                  const SizedBox(height: 24),
                  _buildAquaField(
                      _passwordController, "Password", Icons.lock_outline_rounded, true),
                  const SizedBox(height: 60),
                  ElevatedButton(
                    ...
                    child: const Text("AUTHENTICATE SYSTEM",
                        style: TextStyle(
                  ...
                  TextButton(
                      ...
                      child: const Text("Create New Membership",
                          style: TextStyle(
  ...
  Widget _buildAquaField(TextEditingController controller, String label,
